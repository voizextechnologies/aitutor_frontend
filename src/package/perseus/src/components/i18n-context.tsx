...
import {mockStrings} from "../strings"; // You might need to create this or remove it
...
export const mockPerseusI18nContext = {
    strings: mockStrings || {}, // Fallback to empty object
    locale: "en",
};

// Safe context creation for browser environment
export const PerseusI18nContext: React.Context<I18nContextType> =
    React.createContext(mockPerseusI18nContext); // Always provide default value
